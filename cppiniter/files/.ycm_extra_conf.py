# Generated by YCM Generator at 2017-10-06 19:59:22.299963
...
conan_flags_file = "build/conan_ycm_flags.json"
if os.path.isfile(conan_flags_file):
    conan_flags = json.loads(open(conan_flags_file, "r").read())
    ...
    for flag in flags:
        ...
        for path_flag in path_flags:
            ...
            if flag.startswith(path_flag):
                ...
                new_flag = flag[:len(path_flag)] + \
                    GetAbsolutePath(path, working_directory)
                break
...
def FlagsForFile(filename, **kwargs):
    ...
    _logger.info("Final flags for %s are %s" %
                 (filename, ' '.join(final_flags)))
